...
* /api/faces/\<id\>/suggest/ - return suggestion avatars for faces in photo. \<id\> - photo id.
    * GET: `query` - string by user. It can be empty; `face_id`.
        * HTTP\_CODE: 200 - STATUS: OK, return probable avatars for face, if query was empty, or avatars contains query in name
